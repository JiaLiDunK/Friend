...
@booksRouter.get("/updateChunk")
async def update_chunk(data:Chunk,chunk_db:ChunkDB=Depends(create_chunk_db))->R:
    """更新书籍的分片"""
    logging.info(f"更新书籍的分片:{data}")
